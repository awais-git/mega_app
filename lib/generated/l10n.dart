...
class S {
  ...
  String get delivery_outsourced {
    return Intl.message(
      'La entrega se realizará en coordinación con el cliente',
      name: 'delivery_outsourced',
      desc: '',
      args: [],
    );
  }
  ...
  String get paymentDetailsCheck {
    return Intl.message(
      'Please check your details again',
      name: 'paymentCheckDetails',
      desc: '',
      args: [],
    );
  }
  ...
  String get expiryMonthInvalid {
    return Intl.message(
      'Expiry month is invalid',
      name: 'expiryMonthInvalid',
      desc: '',
      args: [],
    );
  }
