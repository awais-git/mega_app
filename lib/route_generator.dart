...
import 'src/pages/delivery_address_main.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/DeliveryAddressMain':
        return MaterialPageRoute(builder: (_) => DeliveryAddressMainWidget());
      case '/DeliveryAddress':
        return MaterialPageRoute(
            builder: (_) => DeliveryAddressWidget(compra: args));
