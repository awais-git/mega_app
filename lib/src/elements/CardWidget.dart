...
class CardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 110,
      margin: EdgeInsets.only(left: 10, right: 0, top: 15, bottom: 20),
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        // Helper.getDistance(market.distance, Helper.of(context).trans(setting.value.distanceUnit))+" "+market.name,
                        market.name,
