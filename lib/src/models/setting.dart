...
class Setting {
  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      deliveryMin = double.tryParse(jsonMap['delivery_min']) ?? 0.0;
      deliveryExtra = double.tryParse(jsonMap['delivery_extra']) ?? 0.0;
...
//  }
  ...
  Map toMap() {
    ...
    map["delivery_min"] = deliveryMin;
    map["delivery_extra"] = deliveryExtra;
