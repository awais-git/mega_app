                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: ListTile(
                              ...
                              title: Text(
                                "Últimas 5 "+S.of(context).notifications,
                                maxLines: 1,
                          ...
                          ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              onTap: () {
                                Navigator.of(context).pushNamed('/Tracking', arguments: RouteArgument(id: _con.notifications.elementAt(index).data['order_id'].toString()));
                              },
                              child: NotificationItemWidget(notification: _con.notifications.elementAt(index)));
