                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Helper.getPrice(
                                            _con.product.price,
                                            context,
                                            style: Theme.of(context).textTheme.headline2,//DONE - gaston - aqui es el ancho de moneda en detalle de producto
                                          ),
                                          ...
                                          return Wrap(
                                            children: <Widget>[
                                              ListTile(
                                                ...
                                                subtitle: Text("Selecione "+optionGroup.quantity.toString(),
                                                ),
                                              ),
                                              ListView.separated(
                                                padding: EdgeInsets.all(0),
