...
Future<User> register(User user) async {
  ...
  final String url = '${GlobalConfiguration().getValue('api_base_url')}reg';
  final client = new http.Client();
  print('REGISTRO----->'+url);
  print(json.encode(user.toMap()));
  final response = await client.post(
...
Future<bool> resetPassword(User user) async {
  ...
  print(CustomTrace(StackTrace.current, message: "resetPassword URL: $url"));
  print(json.encode(user.toMap()));
  final client = new http.Client();
  final response = await client.post(
    Uri.parse(url),
...
Future<void> logout() async {
  ...
  await prefs.remove('last_product_id');
}
...
Future<Stream<Address>> getAddresses() async {
  ...
  print(CustomTrace(StackTrace.current, message: "getAddresses URL: $url"));
  final client = new http.Client();
